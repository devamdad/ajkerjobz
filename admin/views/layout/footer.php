...
<?php if($page_slug == "manage-admin-super" || $page_slug == "manage-admin-moderator") { ?>
  ...
  <script type="text/javascript" src="../../assets/js/approve-admin.js"></script>
...
<?php if($page_slug == "manage-company") { ?>
  <script type="text/javascript" src="../../assets/js/active-deactive-company.js"></script>
<?php }?>

<?php if($page_slug == "manage-user") { ?>
  <script type="text/javascript" src="../../assets/js/active-deactive-user.js"></script>
<?php }?>
<?php if ($page_slug == "manage-job"){ ?>
  <script type="text/javascript" src="../../assets/js/active-deactive-job.js"></script>
<?php } ?>

<?php if( $page_slug == "manage-job" || $page_slug == "manage-company" || $page_slug == "manage-user") { ?>
