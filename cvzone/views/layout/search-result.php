...
<head>
    <meta charset="utf-8">
    <title>Ajkerjob | Searcv CV</title>
</head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 search-box ">
                <form class="form-horizontal col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-sm-offset-2 col-md-offset-2" action="../php/_search.php" method="post" autocomplete="off">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                include ("../php/_show-search-result.php")
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#footerArea').css("margin-top", viewPortHeight-(344+50) );
        ...
        $("#searchKey").keyup(function() {
            ...
            if (searchValue) {
                ...
                $.post("../php/_search.php", dataToSend, function(data, status){
                    if(status === 'success')
                    {
                        //  alert(data);
