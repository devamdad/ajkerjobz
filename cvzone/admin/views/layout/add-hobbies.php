              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  action="../php/_add-hobbies.php" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="x_content">
                          ...
                          <div id="editor" class="editor-wrapper" name="content" oninput="wordCountHobbies()"></div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success btn-md" name="" onclick="textEditor()">Insert Hobbies</button>
                        </div>
                      </div>
                    </form>
                  </div>
