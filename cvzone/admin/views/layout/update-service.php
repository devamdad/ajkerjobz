...
<?php $page_slug = "update-service" ?>
<!-- Header menue -->
<?php include 'header.php'; ?>
<!-- Header menue -->

<?php $serviceId = $_GET['id']; ?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <h3 style="text-align:center;" class="text-danger">
                      <?php
                      if (isset($_SESSION['errorService'])) {
                        echo $_SESSION['errorService'];
                        unset($_SESSION['errorService']);
                      }
                    ...
                    <?php include '../php/_showUpdate-service.php';?>
                    <form  action="../php/_update-service.php" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <a href="http://fontawesome.io/icons/" target="_blank"> <p>Fontawesome</p></a>
                        </div>
                      </div>

                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" id="postDate" value="<?php echo $serviceId ?>"  name="serviceId">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="x_content">
                          ...
                          <div id="editor" class="editor-wrapper" name="content" oninput="wordCountService()"><?php echo $updateShowDescription; ?></div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success btn-md" name="" onclick="textEditor()">Add Service</button>
                        </div>
                      </div>
                    </form>
                  </div>
