                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <h3 style="text-align:center;" class="text-success">
                      <?php
                      if (isset($_SESSION['aboutSuccess'])) {
                        echo $_SESSION['aboutSuccess'];
                        unset($_SESSION['aboutSuccess']);
                      }
                    ...
                    include '../php/_show-about.php';

                     ?>
                    <form  action="../php/_add-about.php" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  class="form-control col-md-7 col-xs-12" name="phone" value="<?php echo $firstPhone; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="x_content">
                          ...
                          <div id="editor" class="editor-wrapper" name="content" oninput="wordCount()"><?php echo $firstBio;?></div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success btn-md" name="" onclick="textEditor()">Update About</button>
                        </div>
                      </div>
                    </form>
                  </div>
