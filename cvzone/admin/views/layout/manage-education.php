<?php $page_slug = "manage-education"; ?>
<!-- Header menue -->
<?php include 'header.php'; ?>
<!-- Header menue -->
<?php include '../php/_manage-education.php';?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <tr>
                            ...
                            <td><?php echo $show['institute']; ?></td>
                            <td>
                              <a href="update-education.php?id=<?php echo $show['id']; ?>" class="btn btn-success">UPDATE</a>
                              <a  class="btn btn-danger delete-education" data-row="<?php echo $show['id']; ?>">DELETE</a>
                            </td>
	                        </tr>
                      <?php endforeach; ?>
